...
class AboutSections extends Component {
  ...
  render() {
    return (
      /* <!-- About Section --> */
      <section className="w3-content w3-justify w3-text-grey w3-padding-64" id="about">
        <h2 className="w3-text-light-grey">My Name</h2>
        <hr style={{width:"200px"}} className="w3-opacity" />
        <p>
          Some text about me. Some text about me. I am lorem ipsum consectetur adipiscing elit, sed
        ...
        <button type="button" className="w3-button w3-light-grey w3-padding-large w3-section">
        ...
        />
        <p>
          <span className="w3-large w3-margin-right">Chris Fox.</span>
